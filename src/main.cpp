...
uint256 hashGenesisBlock("0x00000442d68e8b0d8c446deb08807e17606276ba4951669208e1ea20d912e9c1");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Taurcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Taurcoin Signed Message:\n";
...
{
    // Taurcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
   ...
   int64 nSubsidy =  1000000;
    
    if (nHeight==1){
                nSubsidy=15000000  * Coin;
        }
        
        if(nHeight > 1 && nHeight < 10500001){
                nSubsidy=10 * Coin;
        }
...
static const int64 nTargetTimespan = 302400; // Taurcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Taurcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Taurcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Taurcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Taurcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3713ff43c4a74aa0e9d7ab0d875b48cb1b4242df11773903e9f501b694d9562a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Expecting sales to grow 15-20% during sankranti";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("a065a36e0dcb78548f4b4ad47e357c5883eb123dae0c7e8fef1913275c69bfcb4420bbcf576d0f1ebb6a4bcb5bc54db825a9a2924c8fc1012fffb002dc2b1ebf7f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1516185917;
        block.nBits    = 504365644;
        block.nNonce   = 1677472191;

        if (fTestNet)
        {
            block.nTime    = 1508227802;
            block.nNonce   = 3806970536;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x457f984636c17a9c4e96b6c622388743c3f494b9405f37e35f1d324073bd39e1"));
        //block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Taurcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TaurcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TaurcoinMiner : ProcessBlock, block not accepted");
    }
